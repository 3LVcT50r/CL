...
public:
  ...
  antlrcpp::Any visitParameter_decl(AslParser::Parameter_declContext *ctx);
  ...
  antlrcpp::Any visitReturnExpr(AslParser::ReturnExprContext *ctx);
  ...
  antlrcpp::Any visitSwapExpr(AslParser::SwapExprContext *ctx);
  antlrcpp::Any visitSwitchExpr(AslParser::SwitchExprContext *ctx);
